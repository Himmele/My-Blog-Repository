========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : SpaceshipCOMClient
========================================================================


Diese SpaceshipCOMClient-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre SpaceshipCOMClient-Anwendung bilden.

SpaceshipCOMClient.h
...
res\SpaceshipCOMClient.ico
    	Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei SpaceshipCOMClient.rc eingebunden.

res\SpaceshipCOMClient.rc2
...
SpaceshipCOMClientDlg.h, SpaceshipCOMClientDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CSpaceshipCOMClientDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in SpaceshipCOMClient.rc, die mit Microsoft Developer Studio
...
StdAfx.h, StdAfx.cpp
	...
	SpaceshipCOMClient.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
