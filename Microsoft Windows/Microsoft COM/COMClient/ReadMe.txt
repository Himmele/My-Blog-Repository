========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : COMClient
========================================================================


Diese COMClient-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre COMClient-Anwendung bilden.
...
COMClient.h
	...
	Anwendungsklasse CCOMClientApp.
...
res\COMClient.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei COMClient.rc eingebunden.
...
COMClientDlg.h, COMClientDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CCOMClientDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in COMClient.rc, die mit Microsoft Developer Studio
...
StdAfx.h, StdAfx.cpp
	...
	COMClient.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
