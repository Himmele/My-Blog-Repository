========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ElectronicCash
========================================================================


Diese ElectronicCash-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre ElectronicCash-Anwendung bilden.
...
ElectronicCash.h
	...
	Anwendungsklasse CElectronicCashApp.
...
res\ElectronicCash.ico
    	Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei ElectronicCash.rc eingebunden.

res\ElectronicCash.rc2
...
ElectronicCashDlg.h, ElectronicCashDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CElectronicCashDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in ElectronicCash.rc, die mit Microsoft Developer Studio
...
StdAfx.h, StdAfx.cpp
	...
	ElectronicCash.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
